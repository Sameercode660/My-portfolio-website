    ...
    <>
      <div className="w-full flex justify-center items-center max-sm:justify-around">
        <div className="flex w-[80%] justify-around m-2 p-1 max-sm:space-x-12 max-sm:w-full">
          ...
          <div className="sm:hidden max-sm:grid place-items-center w-[2.5rem] " onClick={handleOpenCloseNavigation}>
      ...
      <div
        className={` sm:hidden w-[70%] h-[100vh] fixed z-10 top-0 ${position ? "left-0" : "left-[-70%]"} right-0 bottom-0 flex flex-col items-center gap-3 transition-all ease-in duration-500`}
