...
function Home() {
  return (
    <>
      <div className="flex items-center h-[90dvh] max-sm:h-auto relative top-10 w-full justify-evenly max-sm:flex-col-reverse max-sm:gap-10 max-md:flex-col-reverse max-md:h-full max-md:gap-12" style={{backgroundColor: '#1f2937'}}>
        <div className="flex flex-col space-y-10 max-sm:space-y-5 max-md:items-center max-sm:m-1">
          <h1 className="text-6xl max-sm:text-4xl font-semibold max-md:text-5xl max-lg:text-4xl" style={{
            color: 'white',
          ...
          <p className="max-sm:hidden text-justify max-lg:text-[12px]">My name is Mohd Sameer, currently i am pursuing my graduation <br /> and also i am a mern stack web developer, fascinated for developing <br></br> good web application</p>
        ...
        <div>
          ...
          }} className=" w-[400px] h-[400px]  max-sm:w-[200px] max-sm:h-[200px] border-2 rounded-full object-cover max-md:w-[300px] max-md:h-[300px] max-lg:w-[250px] max-lg:h-[250px]" src={logo}  alt="" />
        </div>
      </div>
